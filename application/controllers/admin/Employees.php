    ...
    public function employees_list()
    {
        ...
        foreach ($employee->result() as $r) {
            ...
            elseif ($r->is_active == 1): $status_btn = 'btn-success';
                $status_title = $this->lang->line('xin_employees_active'); endif;
...
//				$r->employee_id,
    ...
    public function add_employee()
    {
        if ($this->input->post('add_type') == 'employee') {
            ...
            $date_of_working = $this->Xin_model->clean_date_post($this->input->post('date_of_working'));
            ...
            $data = array(
                ...
                'office_province' => $this->input->post('office_province'),
